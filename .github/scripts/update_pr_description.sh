...
DOCKER_RUN_COMMAND="docker run -it --rm \
  ...
  -e SANDBOX_RUNTIME_CONTAINER_IMAGE=docker.thinksoft.dev/thinksoft/runtime:${SHORT_SHA}-nikolaik \
  --name thinksoft-app-${SHORT_SHA} \
  docker.thinksoft.dev/thinksoft/thinksoft:${SHORT_SHA}"
