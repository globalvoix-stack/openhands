...
```bash
# npm
npm install @thinksoft/ui

# yarn
yarn add @thinksoft/ui

# pnpm
pnpm add @thinksoft/ui

# bun
bun add @thinksoft/ui
```

## Quick Start

```tsx
import { Button, Typography } from "@thinksoft/ui";
import "@thinksoft/ui/styles";
...
# Replace `path/to/thinksoft-ui-x.x.x.tgz` with the actual path to the generated `.tgz` file.
npm install path/to/thinksoft-ui-x.x.x.tgz
```
