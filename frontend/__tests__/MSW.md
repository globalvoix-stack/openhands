...
> [!NOTE]
> **Thinksoft vs SaaS Mode**
>
> Thinksoft runs in two modes:
> - **Thinksoft mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
