...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => ThinksoftParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is ThinksoftParsedEvent =>
  isThinksoftEvent(event) &&
