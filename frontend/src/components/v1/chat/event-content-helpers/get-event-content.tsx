...
import { ThinksoftEvent, ObservationEvent } from "#/types/v1/core";
...
const getActionEventTitle = (event: ThinksoftEvent): React.ReactNode => {
...
const getObservationEventTitle = (event: ThinksoftEvent): React.ReactNode => {
...
export const getEventContent = (event: ThinksoftEvent | SkillReadyEvent) => {
