...
- `git-version`: The git commit hash or release tag of Thinksoft to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/Thinksoft/evaluation).
...
- [Thinksoft Documentation](https://github.com/Thinksoft/Thinksoft)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [Thinksoft repository](https://github.com/Thinksoft/Thinksoft/issues).
