...
from thinksoft.events.observation import BrowserOutputObservation, CmdOutputObservation
...
def get_config(
    ...
    config = get_thinksoft_config_for_eval(
        max_iterations=100,
        # we mount trajectories path so that trajectories, generated by Thinksoft
...
if __name__ == '__main__':
    ...
    # 1) trajectory is dumped by Thinksoft library (on host machine), but it's needed by
    ...
    config: ThinksoftConfig = get_config(
