...
It is responsible for executing actions received from Thinksoft backend and producing observations.
...
from thinksoft_aci.editor.editor import OHEditor
from thinksoft_aci.editor.exceptions import ToolError
from thinksoft_aci.editor.results import ToolResult
from thinksoft_aci.utils.diff import get_diff
...
class ActionExecutor:
    ...
    async def _init_bash_commands(self):
        ...
        # Hack: for some reason when you set the thinksoft user to anything but root, tmux changes out
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--username', type=str, help='User to run as', default='thinksoft'
    )
