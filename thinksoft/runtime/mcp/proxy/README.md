...
This module provides a manager class for handling FastMCP proxy instances in Thinksoft, including initialization, configuration, and mounting to FastAPI applications.
