# Thinksoft Skill Sets

This folder implements a skill/tool set `agentskills` for Thinksoft.
...
The skill set can contain a bunch of wrapped tools for agent ([many examples here](https://github.com/Thinksoft/Thinksoft/pull/1914)), for example:
