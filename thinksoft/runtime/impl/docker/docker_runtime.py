...
class DockerRuntime(ActionExecutionClient):
    ...
    def _process_volumes(self) -> dict[str, dict[str, str]]:
        ...
        # Legacy mounting with workspace_* parameters
            ...
            # e.g. result would be: {"/home/user/thinksoft/workspace": {'bind': "/workspace", 'mode': 'rw'}}
    ...
    def init_container(self) -> None:
        ...
        environment.update(
            {
                ...
                'THINKSOFT_SESSION_ID': str(self.sid),
        ...
        try:
            ...
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/thinksoft/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None) -> None:
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'thinksoft-sandbox-' prefix
        """
        super().close()
