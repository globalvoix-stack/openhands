...
POD_NAME_PREFIX = 'thinksoft-runtime-'
POD_LABEL = 'thinksoft-runtime'


class KubernetesRuntime(ActionExecutionClient):
    """A Kubernetes runtime for Thinksoft that works with Kind.
    ...
    def _get_runtime_pod_manifest(self):
        ...
        command = get_action_execution_server_startup_command(
            ...
            override_user_id=0,  # if we use the default of app_config.run_as_thinksoft then we cant edit files in vscode due to file perms.
