...
if sys.platform == 'win32':
    try:
        ...
        from thinksoft.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
The .NET SDK and PowerShell are required for Thinksoft CLI on Windows.
...
class CLIRuntime(Runtime):
    ...
    def __init__(
        ...
        if self.config.workspace_base is not None:
            ...
            self._workspace_path = tempfile.mkdtemp(
                prefix=f'thinksoft_workspace_{sid}_'
            )
    ...
    async def delete(cls, conversation_id: str) -> None:
        ...
        prefix = f'thinksoft_workspace_{conversation_id}_'
