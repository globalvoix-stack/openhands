# Thinksoft Architecture

This directory contains the core components of Thinksoft.

For an overview of the system architecture, see the [architecture documentation](https://docs.thinksoft.dev/usage/architecture/backend) (v0 backend architecture).

## Classes

The key classes in Thinksoft are:
...
* Server: brokers Thinksoft sessions over HTTP, e.g. to drive the frontend
...
The EventStream serves as the backbone for all communication in Thinksoft.
...
Please refer to the [documentation](https://docs.thinksoft.dev/usage/architecture/runtime) to learn more about `Runtime`.
