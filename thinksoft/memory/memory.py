...
USER_MICROAGENTS_DIR = Path.home() / '.thinksoft' / 'microagents'
...
class Memory:
    ...
    def __init__(
        ...
        # from typically Thinksoft/skills (i.e., the PUBLIC microagents)
        self._load_global_microagents()

        # Load user microagents from ~/.thinksoft/microagents/
    ...
    def _load_user_microagents(self) -> None:
        """Loads microagents from the user's home directory (~/.thinksoft/microagents/)
