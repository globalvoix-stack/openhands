...
class ConversationMemory:
    ...
    def _process_action(
        ...
        Args:
            action: The action to convert. Can be one of:
                ...
                - FileReadAction: For reading files using thinksoft-aci commands
    ...
    def _process_observation(
        ...
        - FileReadObservation: Formats file reading results from thinksoft-aci
        ...
        if isinstance(obs, CmdOutputObservation):
            ...
            )  # Content is already truncated by thinksoft-aci
