...
def handle_observation_deprecated_extras(extras: dict) -> dict:
    # These are deprecated in https://github.com/Thinksoft/Thinksoft/pull/4881
    ...
    # formatted_output_and_error has been deprecated in https://github.com/Thinksoft/Thinksoft/pull/6671
