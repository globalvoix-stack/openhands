...
# Add the project root to the Python path so we can import Thinksoft modules
# From alembic/env.py, we need to go up 5 levels to reach the Thinksoft project root
...
def run_migrations_offline() -> None:
    ...
    if db_session.host:
        ...
        url = f'sqlite:///{db_session.persistence_dir}/thinksoft.db'
