...
from thinksoft.agent_server.models import ThinksoftModel, SendMessageRequest
...
class AppConversationStartRequest(ThinksoftModel):
...
class AppConversationStartTask(ThinksoftModel):
    ...
    app_conversation_id: ThinksoftUUID | None = Field(
...
class AppConversationStartTaskPage(ThinksoftModel):
