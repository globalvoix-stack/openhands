"""Sandboxed Conversation router for Thinksoft App Server."""
...
async def get_conversation_skills(
    ...
    - Global skills (Thinksoft/skills/)
    - User skills (~/.thinksoft/skills/)
    - Organization skills (org/.thinksoft repository)
    - Repository skills (repo/.thinksoft/skills/ or .thinksoft/microagents/)
