...
async def get_conversation_link(
    ...
    """Appends a followup link, in the PR body, to the Thinksoft conversation that opened the PR"""
...
async def create_pr(
    ...
    """Open a PR in GitHub"""
    logger.info('Calling Thinksoft MCP create_pr')

    request = get_http_request()
    headers = request.headers
    conversation_id = headers.get('X-Thinksoft-ServerConversation-ID', None)
...
async def create_mr(
    ...
    """Open a MR in GitLab"""
    logger.info('Calling Thinksoft MCP create_mr')
...
async def create_bitbucket_pr(
    ...
    logger.info('Calling Thinksoft MCP create_bitbucket_pr')
...
async def create_azure_devops_pr(
    ...
    logger.info('Calling Thinksoft MCP create_azure_devops_pr')
