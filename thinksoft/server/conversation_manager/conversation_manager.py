...
class ConversationManager(ABC):
    """Abstract base class for managing conversations in Thinksoft.
    ...
    This is an extension point in Thinksoft, that applications built on it can use to modify behavior via server configuration, without modifying its code.
