...
PR_SIGNATURE = (
    'Automatic fix generated by [Thinksoft](https://github.com/Thinksoft/Thinksoft/) 🙌'
)
...
def make_commit(
    ...
    issue: Issue,
    issue_type: str,
    git_user_name: str = 'thinksoft',
    git_user_email: str = 'thinksoft@all-hands.dev',
) -> None:
    ...
    if not status_result.stdout.strip():
        ...
        raise RuntimeError('ERROR: Thinksoft failed to make code changes.')
...
def send_pull_request(
    ...
    base_branch_name = f'thinksoft-fix-issue-{issue.number}'
...
def update_existing_pull_request(
    ...
    if not comment_message and additional_message:
        try:
            ...
            if explanations:
                comment_message = (
                    'Thinksoft made the following changes to resolve the issues:\n\n'
                )
            ...
            comment_message = (
                'A new Thinksoft update is available, but failed to parse or summarize '
                f'the changes:\n{additional_message}'
            )
