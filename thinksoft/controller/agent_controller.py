...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        Thinksoft is a multi-agentic system. A `task` is a conversation between
        Thinksoft (the whole system) and the user, which might involve one or more inputs
        ...
        if action.runnable:
            if self.state.confirmation_mode and (
                ...
                if self.agent.config.cli_mode:
                    ...
                    # See issue: https://github.com/Thinksoft/Thinksoft/issues/10464
