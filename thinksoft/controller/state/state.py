...
@dataclass
class State:
    """Represents the running state of an agent in the Thinksoft system, saving data of its operation and memory.
    ...
    def to_llm_metadata(self, model_name: str, agent_name: str) -> dict:
        metadata = {
            ...
            'trace_version': thinksoft.__version__,
            'trace_user_id': self.user_id,
            'tags': [
                f'model:{model_name}',
                f'agent:{agent_name}',
                f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
                f'thinksoft_version:{thinksoft.__version__}',
            ],
        }
        return metadata
