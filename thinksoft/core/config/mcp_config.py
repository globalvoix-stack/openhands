...
class ThinksoftMCPConfig:
    @staticmethod
    def add_search_engine(app_config: 'ThinksoftConfig') -> MCPStdioServerConfig | None:
        ...
        # Do not add search engine to MCP config in SaaS mode since it will be added by the Thinksoft server
        return None
    ...
    def create_default_mcp_server_config(
        ...
        """
        stdio_servers = []
        search_engine_stdio_server = ThinksoftMCPConfig.add_search_engine(config)
...
thinksoft_mcp_config_cls = os.environ.get(
    'THINKSOFT_MCP_CONFIG_CLS',
    'thinksoft.core.config.mcp_config.ThinksoftMCPConfig',
)

ThinksoftMCPConfigImpl = get_impl(ThinksoftMCPConfig, thinksoft_mcp_config_cls)
