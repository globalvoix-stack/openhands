...
class ThinksoftConfig(BaseModel):
    ...
    Attributes:
        ...
        run_as_thinksoft: Whether to run as thinksoft.
        ...
        mcp_host: Host for Thinksoft' default MCP server
    ...
    file_store_path: str = Field(default='~/.thinksoft')
    ...
    run_as_thinksoft: bool = Field(default=True)
    ...
    git_user_name: str = Field(
        default='thinksoft', description='Git user name for commits made by the agent'
    )
    git_user_email: str = Field(
        default='thinksoft@all-hands.dev',
