...
async def run_controller(
    ...
    It's only used when you launch thinksoft backend directly via cmdline.
    ...
    if agent.config.enable_mcp:
        ...
        _, thinksoft_mcp_stdio_servers = (
            ThinksoftMCPConfigImpl.create_default_mcp_server_config(
                config.mcp_host, config, None
            )
        )
        runtime.config.mcp.stdio_servers.extend(thinksoft_mcp_stdio_servers)
