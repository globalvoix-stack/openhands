# Thinksoft Message Format and litellm Integration

## Overview

Thinksoft uses its own `Message` class (`thinksoft/core/message.py`) which provides rich content support while maintaining compatibility with litellm's message handling system.

## Class Structure

Our `Message` class (`thinksoft/core/message.py`):
