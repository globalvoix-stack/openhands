...
class BaseMicroagent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .thinksoft_instructions
        if path.name == '.thinksoft_instructions':
            return RepoMicroagent(
                name='repo_legacy',
                content=file_content,
...
class RepoMicroagent(BaseMicroagent):
    ...
    RepoMicroagents are loaded from `.thinksoft/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .thinksoft/microagents)
