...
def _setup_common_mocks():
    ...
    return {
        'config': patch('thinksoft.server.routes.manage_conversations.config'),
        'conversation_manager': patch(
            'thinksoft.server.routes.manage_conversations.conversation_manager'
        ),
        'wait_all': patch(
            'thinksoft.server.routes.manage_conversations.wait_all',
...
async def test_get_microagent_management_conversations_success():
    ...
    with (
        ...
        patch('thinksoft.server.routes.manage_conversations.config') as mock_config,
        patch(
            'thinksoft.server.routes.manage_conversations.conversation_manager'
        ) as mock_conv_mgr,
        patch(
...
async def test_get_microagent_management_conversations_no_results():
    ...
    with (
        patch('thinksoft.server.routes.manage_conversations.ProviderHandler'),
        patch('thinksoft.server.routes.manage_conversations.config') as mock_config,
        patch(
            'thinksoft.server.routes.manage_conversations.conversation_manager'
        ) as mock_conv_mgr,
