...
from thinksoft.runtime.utils import git_changes, git_diff, git_handler
...
class TestGitHandler(unittest.TestCase):
    ...
    def test_get_git_changes_fallback(self):
        ...
        with patch(
            'thinksoft.runtime.utils.git_handler.GIT_CHANGES_CMD',
    ...
    def test_get_git_diff_fallback(self):
        ...
        with patch(
            'thinksoft.runtime.utils.git_handler.GIT_DIFF_CMD', 'non-existant-command'
        ):
