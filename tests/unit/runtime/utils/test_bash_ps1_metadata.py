...
###PS1JSON###
{
  ...
  "working_dir": "/home/runner/work/Thinksoft/Thinksoft",
  "py_interpreter_path": "/home/runner/.cache/pypoetry/virtualenvs/thinksoft-ai-ULPBlkAi-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert metadata.working_dir == '/home/runner/work/Thinksoft/Thinksoft'
    assert (
        metadata.py_interpreter_path
        == '/home/runner/.cache/pypoetry/virtualenvs/thinksoft-ai-ULPBlkAi-py3.12/bin/python'
    )
