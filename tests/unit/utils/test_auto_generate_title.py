...
from thinksoft.utils.conversation_summary import auto_generate_title
...
async def test_auto_generate_title_with_llm():
    ...
    with patch(
        'thinksoft.utils.conversation_summary.EventStore'
...
async def test_update_conversation_with_title():
    ...
    with patch(
        'thinksoft.server.conversation_manager.standalone_conversation_manager.auto_generate_title',
