...
from thinksoft.agenthub.codeact_agent.tools.browser import (
...
from thinksoft.agenthub.readonly_agent.readonly_agent import ReadOnlyAgent
...
from thinksoft.core.exceptions import FunctionCallNotExistsError
...
from thinksoft.memory.condenser import View
...
def test_get_system_message(create_llm_registry):
    ...
    assert 'You are Thinksoft agent' in result.content
