...
class ThinksoftPR(Base):  # type: ignore
    """
    Represents a pull request created by Thinksoft.
    """

    __tablename__ = 'thinksoft_prs'
    ...
    thinksoft_helped_author = Column(Boolean, nullable=True)
    num_thinksoft_commits = Column(Integer, nullable=True)
    num_thinksoft_review_comments = Column(Integer, nullable=True)
    num_thinksoft_general_comments = Column(Integer, nullable=True)
