...
These tests are designed to work without the full Thinksoft dependency chain.
...
class TestUserVersionUpgradeProcessorStandalone:
    """Standalone tests for UserVersionUpgradeProcessor without Thinksoft dependencies."""
