...
class SaaSExperimentManager(ExperimentManager):
    ...
    def run_config_variant_test(
        user_id: str | None, conversation_id: str, config: ThinksoftConfig
    ) -> ThinksoftConfig:
        """
        Run agent config variant test and potentially modify the Thinksoft config
        ...
        Returns:
            The modified Thinksoft configuration
        """
        logger.info(
        ...
        # Pass the entire Thinksoft config to the system prompt experiment
